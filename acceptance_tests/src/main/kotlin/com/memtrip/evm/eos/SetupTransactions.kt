...
import com.memtrip.evm.eos.Config.CONTRACT_ACCOUNT_NAME
import com.memtrip.evm.eos.Config.DEFAULT_RAM_ISSUE
import com.memtrip.evm.eos.Config.FAULT_THRESHOLD
import com.memtrip.evm.eos.Config.SEED_PRIVATE_KEY
...
class SetupTransactions(
    ...
    fun createEthAccount(
        ...
        return createEthAccount(accountName, privateKey, ethAccount.address)
    }
    ...
    fun sstore(
        ...
        val instruction = "7F${value}7F${key}55"
