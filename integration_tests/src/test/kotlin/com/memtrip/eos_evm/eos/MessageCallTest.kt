...
class MessageCallTest {
    ...
    fun `internal message call to a subcontract`() {
        ...
        val payableAddress: String = if (contractCode is GetCode.Record.Multiple) {
            assertEquals(
                "",
        ...
        assertTrue(
            callTransactionResponse.containsConsoleString(
