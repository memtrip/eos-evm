...
class InnerMessageCallTest {
    ...
    @Test
    fun `internal message call to a subcontract is not processed when the parent contract has a balance less than the transaction value argument`() {
        // given
        val (contractAccountName, contractAccountPrivateKey, contractEthAccount) = setupTransactions.seed()
        val contractAccountIdentifier = AccountIdentifier.create(contractAccountName, contractEthAccount.address)
        ...
        callTransactionResponse.assertNotConsoleString(
            "LOG(topics=[2230ca5690d71a74605e39bd522eea4bff3859bc627abd4ac5e473fcb8c5c3b0], data=00000000000000000000000000000000000000000000000000000000000117e6)"
        )
    }
}