...
TEST_CASE("Transaction call", "[transaction)]") {
  ...
  CHECK("095e7baea6a6c7c4c2dfeb977efac326af552d87" == Hex::bytesToHex(Transaction::address(rlp)));
  CHECK(uint256_t(0x0a) == Transaction::value(rlp));
  CHECK("" == Hex::bytesToHex(Transaction::data(rlp)));
  CHECK("1b" == Hex::bytesToHex(Transaction::v(rlp)));
  CHECK("48b55bfa915ac795c431978d8a6a992b628d557da5ff759b307d495a36649353" == Hex::bytesToHex(Transaction::r(rlp)));
  CHECK("efffd310ac743f371de3b9f7f9cb56c0b28ad43601b4ab949f53faa07bd2c804" == Hex::bytesToHex(Transaction::s(rlp)));
...
TEST_CASE("Transaction contract", "[transaction)]") {
  ...
  bytes_t data = Transaction::data(rlp);
