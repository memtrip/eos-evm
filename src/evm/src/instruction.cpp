...
const instruct_t Instruction::values[] = {
  ...
  0x0B020103, // ((SIGNEXTEND (0x0B)), 2, 1, LOW)
  ...
  0x88090A02, // ((DUP9 (0x88)), 9, 10, VERY_LOW)
  0x890A0B02, // ((DUP10 (0x89)), 10, 11, VERY_LOW)
  0x8A0B0C02, // ((DUP11 (0x8A)), 11, 12, VERY_LOW)
  0x8B0C0D02, // ((DUP12 (0x8B)), 12, 13, VERY_LOW)
  0x8C0D0E02, // ((DUP13 (0x8C)), 13, 14, VERY_LOW)
  0x8D0E0F02, // ((DUP14 (0x8D)), 14, 15, VERY_LOW)
  0x8E0F1002, // ((DUP15 (0x8E)), 15, 16, VERY_LOW)
  0x8F101102, // ((DUP16 (0x8F)), 16, 17, VERY_LOW)
  ...
  0x980A0A02, // ((SWAP9 (0x98)), 10, 10, VERY_LOW)
  0x990B0B02, // ((SWAP10 (0x99)), 11, 11, VERY_LOW)
  0x9A0C0C02, // ((SWAP11 (0x9A)), 12, 12, VERY_LOW)
  0x9B0D0D02, // ((SWAP12 (0x9B)), 13, 13, VERY_LOW)
  0x9C0E0E02, // ((SWAP13 (0x9C)), 14, 14, VERY_LOW)
  0x9D0F0F02, // ((SWAP14 (0x9D)), 15, 15, VERY_LOW)
  0x9E101002, // ((SWAP15 (0x9E)), 16, 16, VERY_LOW)
  0x9F111102, // ((SWAP16 (0x9F)), 17, 17, VERY_LOW)
