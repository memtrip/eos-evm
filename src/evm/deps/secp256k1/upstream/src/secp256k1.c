...
struct secp256k1_context_struct {
    ...
    { 0 },	secp256k1_context *secp256k1_context_create_with_prec(unsigned int flags, void *prec)
    { 0 },	{
    { default_illegal_callback_fn, 0 },	    secp256k1_context *ret = (secp256k1_context *)checked_malloc(&default_error_callback, sizeof(secp256k1_context));
    { default_error_callback_fn, 0 }	    ret->illegal_callback = default_illegal_callback;
